...
C
      ...
      INTEGER*2  SYSGDP(40)
      INCLUDE  'RCACM'
CH END OF FILE ENCOUNTERED WHILE READING BOUNDARY CONDITION FILE
...
C 
       OPEN(IN,FILE='./inputfile/userfile.inp',STATUS='OLD')
       !open(OUT,file='RCA_STD.out',FORM='FORMATTED')
