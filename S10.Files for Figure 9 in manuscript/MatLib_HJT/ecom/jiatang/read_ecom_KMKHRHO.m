function [KMKHRHO,StopInfo] = read_ecom_KMKHRHO(FileToRead,GridInfo,iStep)
...
try
    m = memmapfile(...
        ...
        'uint32'  [1]  'tag6';
        'uint32'  [1]  'tag7';
        'single' [GridInfo.nx GridInfo.ny] 'WTSURF';
        'uint32'  [1]  'tag8';
        }, ...
        'Repeat',1,  ...
        'offset',(iStep-1)*4*(3+2*(2+GridInfo.nx*GridInfo.ny*GridInfo.nz)+2+GridInfo.nx*GridInfo.ny) ... %数据块的大小
        );
    mdata = m.data;
catch ME
